...
Rails.application.configure do
  ...
  # # #成功(Gmail)---------------------------------------------------------------------------
  # #解決①アプリパスワード発行＆安全性の低いアプリからの通信を許可
  # #メール設定
  ...
  #   user_name: '＜Googleアカウントアドレス＞',
  #   #gmail２段階認証回避のためにアプリケーションでの利用パスワードを取得、必ずcredentials.yml.endに設定を！！
  #   password: '＜２段階認証の場合はアプリパスワード＞',
  #   # password: '<Googleアカウントパスワード>',
  #   #パスワードをBase64でエンコード
  ...
  # config.active_job.queue_name_prefix = "mailsend_production"
